	...
	<div class="modal-dialog modal-dialog-centered" style="width: 430px;">
		<div class="modal-content">
			...
			<div class="modal-body select-wrapper" style="padding: 0 30px 30px;">
				<a class="button-basic prefix kakao" style="width: 100%;" onclick="shareToKakao('', 'http://localhost/product/daily/view.do?tag=${dto.products_tag }')"> <i class="ico"></i> 카카오톡으로 공유
