	...
	<div class="checkout-input-box">
		...
		<div class="form-input">
			<dl>
				...
				<dd>
					<input type="text" data-receiver="" id="receiver" name="drk_receiver" title="이름을 입력하세요" placeholder="이름을 입력하세요"
		...
		<div class="form-input">
			<dl>
				...
				<dd>
					<input type="tel" id="tel" name="drk_tel" maxlength="13" title="휴대폰번호를 입력하세요" placeholder="휴대폰번호를 입력하세요"
		...
		<div class="form-input">
			<dl>
				...
				<dd>
					<input id="zipcode" readonly name="drk_zip_code" title="주소찾기 버튼을 눌러주세요" placeholder="주소찾기 버튼을 눌러주세요"
		...
		<div class="form-input">
			<dl>
				...
				<dd>
					<input type="text" id="addrRoad" name="drk_addr" title="주소 입력" placeholder="" readonly value=""
		...
		<div class="form-input">
			<dl>
				...
				<dd>
				<input type="text" id="addrDetail" name="drk_addr_detail" title="상세주소 입력" placeholder="상세주소 입력" value=""
		...
		<div class="form-input">
			<dl>
				...
				<dd>
					<input id="memo" name="drk_memo" title="배송메모를 입력하세요" placeholder="배송메모를 입력하세요" value="" data-init="">
				</dd>
			</dl>
		</div>
			...
			<dl>
				...
				<dd>
					<div class="radio-area radio-type2">
						<div class="radio">
							<input type="radio" value="0" id="deliveryPlaceH" name="drk_ship_loc">
							<label for="deliveryPlaceH">가정</label>
						</div>
						<div class="radio">
							<input type="radio" value="1" id="deliveryPlaceO" name="drk_ship_loc">
