														...
														<c:choose>
															<c:when test="${ coupon.discount > 1 }">
																<option value="${ i }"
																	...
																	data-duplicate="${ coupon.duplication }"
																	data-max-discount="${ coupon.maxDiscount }"
																	data-discount="${coupon.discount}"
																	data-coupon-name="${ coupon.couponName }">${ coupon.couponName }&nbsp;&nbsp;/&nbsp;&nbsp;
																	<fmt:formatNumber value="${ coupon.discount }"
																		type="number"></fmt:formatNumber>원 할인
																</option>
															</c:when>
															<c:otherwise>
																<fmt:formatNumber value="${ coupon.discount }"
																...
																<option value="${ i }"
																	...
																	data-duplicate="${ coupon.duplication }"
																	data-max-discount="${ coupon.maxDiscount }"
																	data-discount="${coupon.discount * 100}"
																	data-coupon-name="${ coupon.couponName }">${ coupon.couponName }&nbsp;&nbsp;/&nbsp;&nbsp;
																	<fmt:formatNumber value="${ coupon.discount }"
																		type="percent"></fmt:formatNumber> 할인
																</option>
															</c:otherwise>
														</c:choose>
