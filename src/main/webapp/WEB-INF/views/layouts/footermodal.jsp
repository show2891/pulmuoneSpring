	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body" style="padding: 40px">
				<div class="p-cont">
					<p>
						풀무원녹즙 홈페이지 회원들에게 무차별적으로 보내지는 타사의 메일을 차단하기 위해, 본 웹사이트에 게시된 이메일 주소가 전자우편 수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단으로 수집되는 것을 거부하며 이를 위반시 <span class="fc-orange">정보통신망법에 의해 형사 처벌</span> 됨을 유념하시기 바랍니다.
					</p>
					<br>
	...
	<div class="modal-dialog modal-dialog-centered" style="width: 430px;">
		<div class="modal-content">
			...
			<div class="modal-body select-wrapper" style="padding: 0 30px 30px;">
				<a class="button-basic prefix kakao" style="width: 100%;" onclick="shareToKakao('', '')"> <i class="ico"></i> 카카오톡으로 공유
				</a> <a class="button-basic prefix link" style="width: 100%; margin-top: 14px;" data-clipboard-target="#share_url_input"> <i class="ico"></i> URL 복사하기
				</a>
			</div>
		</div>
	</div>
					...
					<div class="agreement-wrap">
						<table style="width: 100%">
							<tbody>
								...
								<tr>
									<td style="font-weight: bold">신상품 홍보 및 맞춤형 광고, 광고성 정보 (메시지전송)</td>
									<td>성명, 휴대전화번호, 생년월일, 성별, 주소</td>
									<td style="font-weight: bold">회원 탈퇴 및 동의 철회 시</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="agreement-wrap">
						<table style="width: 100%;">
							<tbody>
								...
								<tr>
									<td style="font-weight: bold">광고성 정보 (메시지전송)</td>
									<td>휴대전화번호</td>
									<td style="font-weight: bold">회원 탈퇴 및 동의 철회 시</td>
								</tr>
							</tbody>
...
.agree-wrap .agree-cont .agree-inner .agree-title {
	font-size: 18px;
	padding-bottom: 10px;
	border-bottom: 1px #e5e5e5 solid;
	margin-bottom: 10px;
						...
						<div class="agree-wrap">
							...
							<div class="agree-cont">
								...
								<div class="agree-inner">
									...
									<ul>
										<li><span class="num">①</span> “풀무원녹즙 홈페이지”는 컴퓨터 등 정보통신설비의 보수점검,교체 및 고장, 통신의 두절 등의 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할 수 있습니다.</li>
								...
								<div class="agree-inner">
									...
									<ul>
										<li><span class="num">①</span> 회원 가입은 개인의 경우 만 14세 이상이면 신청할 수 있으며, “제6조 ”이 정한 가입 양식에 따라 회원정보를 기입한 후 이 약관에 동의한다는 의사표시를 함으로서 회원가입을 신청합니다.</li>
								...
								<div class="agree-inner">
									...
									<ul>
										<li><span class="num">①</span> 회원은 “풀무원녹즙 홈페이지”에 언제든지 탈퇴를 요청할 수 있으며 “풀무원녹즙 홈페이지”는 즉시 회원탈퇴를 처리합니다. 단, 탈퇴 시 기존 아이디로는 재가입이 불가능 합니다.</li>
								...
								<div class="agree-inner">
									...
									<ul>
										<li><span class="num">①</span> “풀무원녹즙 홈페이지”가 회원과 비회원에 대한 통지를 하는 경우, 회원이 “풀무원녹즙 홈페이지”와 미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.</li>
								...
								<div class="agree-inner">
									...
									<ul>
										...
										<li><span class="num">④</span> 이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의 내용이 표시·광고 내용과 다르거나 계약 내용과 다르게 이행된 때에는 당해 재화 등을 공급받은 날부터 3월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회 등을 할 수 있습니다.</li>
									</ul>
								</div>
								<div class="agree-inner">
									...
									<ul>
										...
										<li><span class="num">②</span> “풀무원녹즙 홈페이지”는 위 대금을 환급함에 있어서 이용자가 신용카드 또는 전자화폐 등의 결제 수단으로 재화 등의 대금을 지급한 때에는 지체 없이 당해 결제수단을 제공한 사업자로 하여금 재화 등의 대금의 청구를 정지 또는 취소하도록 요청합니다.</li>
	...
	margin-bottom: 10px;
					...
					<div class="" style="padding: 0 30px 30px">
						<div class="agree-wrap">
							...
							<div class="agree-cont">
								...
								<div class="agree-inner">
									...
									<ol>
										...
										<li><span>②</span> ② 회사는 마케팅 등을 위하여 필요한 최소한의 범위 내에서 회원 작성 자료에 대하여 복제, 공연, 공중송신, 전시, 배포, 대여하거나 2차적 저작물을 작성할 수 있습니다. 이러한 범위 안에서 회원은 저작권법에 따라 회사 및 그 계열회사에 회원 작성 자료의 이용을 무상으로 허락한 것으로 간주합니다.</li>
										<li><span>③</span> ③ 회원은 각자의 회원 작성 자료가 제3자의 권리를 침해하지 않도록 하여야 합니다. 회사는 회원 작성 자료의 제3자 권리 침해 여부에 대해서는 어떠한 적극적∙실질적 조사도 수행하지 아니하므로, 회원은 회원 작성 자료가 회사의 승인 절차를 거쳤다거나 일정 기간 동안 회사에 의하여 삭제되지 않았다는 등의 이유로 회사가 제3자에 대한 권리 침해에 기여한 것이라 주장할 수 없습니다.</li>
										<li><span>④</span> ④ 회사가 회원으로부터 서비스 이용에 대한 대가를 지급받지 않는 한, 회사는 회원 작성 자료를 안전하게 보관할 의무를 부담하지 아니하며, 정책에 따라 회원 작성 자료를 삭제함으로써 발생하는 어떠한 책임도 부담하지 않습니다. 개별 회원은 필요 시 각자의 회원 작성 자료를 복제하여 별도의 장치에 안전하게 보관하여야 합니다.</li>
										<li><span>⑤</span> ⑤ 회사는 회원 작성 자료가 다음 각 호의 경우에 해당한다고 판단되는 경우 사전 통지 없이 삭제할 수 있습니다.
											<ul>
							...
							<p>부칙 1. 이 약관은 2020년 3월 10일부터 시행합니다.</p>
							<!-- 20200309 약관 문구 추가 -->
				...
				<div class="dropdown site-link" style="padding-block: 20px; margin-top: 10px; border-top: 1px solid #e5e5e5; margin-inline: 10px;">
					<button class="btn dropdown-toggle" type="button" style="width: 230px" data-toggle="dropdown" aria-expanded="false">이용약관 변경이력</button>
					<div class="dropdown-menu" style="width: 230px">
						<a class="dropdown-item" data-idx="1" href="javascript:void(0)">2023-01-25 시행</a> <a class="dropdown-item" data-idx="2" href="javascript:void(0)">2020-03-10 시행</a>
					</div>
				</div>
			</div>
		</div>
