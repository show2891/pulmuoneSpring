      ...
      <div class="container curation">
         ...
         <div class="question-part">
            ...
            <div class="button-set">
               ...
               <button class="button-basic border bottles prefix" onclick="location.href='/customer/product/result/${score}?singleYn=N'">
