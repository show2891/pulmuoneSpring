...
<div class="wrapper">
	...
	<main class="step1">
		<div id="container-wrapper" class="container-wrapper">
			...
			<input type="hidden" name="customerType" /> <input type="hidden" name="value" />
						...
						<div class="selector" style="padding: 95px 0px 120px">
							<div class="curation-depth" style="padding-top: 30px">
								<div class="text-wrapper" style="margin-bottom: 35px">
									<h3>
										<b>건강목표, 식이섭취, 생활습관</b>에 대해서<br /> 간단한 설문에 참여하시면 당신에게 맞는<br /> 녹즙 프로그램을 큐레이션 해드립니다.
									</h3>
								</div>
							...
							<div class="kids-depth" style="padding-top: 30px">
								...
								<a href="/customer/product/result/kids?singleYn=N" class="button-basic border" style="font-size: 16px">키즈제품 바로가기</a>
